...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		[Min(1.0f)] [SerializeField] private float stepRate = 2.0f;
		...
		public void OnTriggerEnter(Collider other)
		{
			...
			{
				message = "Press E to interact, press F to throw";
			}
		...
		void OnGUI()
		{
			GUI.Label(new Rect(0, 0, 600, 600), message);
		}
	}
}